  ...
  return (
    <article className="product-card">
      <Link className="product-image-link" to={`/products/${product._id}`}>
        ...
        <span className="product-badge">{categoryLabels[product.category] || product.category}</span>
      </Link>
      <div className="product-body">
        ...
        <div className="price-row">
          <div>
            <span>Giá thuê</span>
            <strong>{money(product.rentalPricePerDay)} đ/ngày</strong>
          </div>
          <div>
            <span>Tiền cọc</span>
            <strong>{money(product.depositAmount)} đ</strong>
          </div>
        </div>
