    ...
    <div className="home-page">
      ...
      <section className="section-block" id="catalog">
        <div className="section-heading split-heading">
          ...
          <p>Danh sách lấy trực tiếp từ MongoDB. Nếu chưa thấy sản phẩm, hãy chạy seed dữ liệu mẫu.</p>
        </div>
        ...
        {!loading && !error && products.length === 0 && <div className="empty-state">Chưa có sản phẩm hiển thị. Chạy <strong>npm run seed</strong> để thêm dữ liệu mẫu.</div>}
      ...
      <section className="cta-section">
        <div>
          ...
          <h2>Tạo tài khoản để đặt thuê, theo dõi đơn và chat hỗ trợ.</h2>
        </div>
