...
const Register = () => {
  ...
  const [form, setForm] = useState({ fullName: '', email: '', password: '', role: 'renter' });
    ...
    <section className="auth-page">
      ...
      <div className="form-card auth-card">
        ...
        <form onSubmit={handleSubmit} className="input-group auth-form">
          ...
          <select name="role" value={form.role} onChange={handleChange} style={{ background: 'white' }}>
            <option value="renter">Khách thuê trang phục (Customer)</option>
            <option value="lender">Cửa hàng cho thuê đồ (Shop Owner)</option>
          </select>
